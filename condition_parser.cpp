...
template <class It> shared_ptr<Node> ParseComparison(It& current, It end) { // parse compare operation
  if (current == end) {
...
template <class It>
shared_ptr<Node> ParseExpression(It& current, It end, unsigned precedence) { // parse logical operation
  if (current == end) {
